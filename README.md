...
## Flask
This Python app used to control video recording process, recording itself is performed by Gstreamer media processing. App performs recording monitoring, recording scheduling, and cleaning.
